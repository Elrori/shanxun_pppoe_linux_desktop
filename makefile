...
#bcm2710(raspberrypi3)'s Toolchain dowmload from https://downloads.lede-project.org/snapshots/targets/brcm2708/bcm2710/lede-sdk-brcm2708-bcm2710_gcc-5.4.0_musl-1.1.15_eabi.Linux-x86_64.tar.bz2  openwrt(lede) on bcm2710 test OK
...
CC=$(LOCATION)/bin/x86_64-linux-gnu-gcc
